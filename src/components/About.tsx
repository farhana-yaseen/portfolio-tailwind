...
export default function AboutUs() {
    ...
    return (
        ...
        <div className="bg-black font-serif w-full h-full text-white">
            <h1 className="p-5 md:p-8 lg:p-12 text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold ">Portfolio</h1>

            <div className="flex justify-center items-center p-5 md:p-8 lg:p-12 xl:p-16">

                {/* Left content (Image) */}
                {/* Profile Picture*/}
                <Image src={"/profileImg.jpg"} alt={"Profile Picture"} width={300} height={300} className="px-auto md:shadow-xl shadow-lg shadow-white w-40 h-40 lg:w-60 lg:h-60 xl:w-80 lg:h-80 rounded-full object-cover"></Image>
                <div>
                ...
                <div className="px-8 md:px-12 lg:px-20  ">
                    ...
                    <h1 className="bg-purple-500 text-2xl lg:text-4xl xl:text-5xl text-center font-bold rounded-md">About Me</h1>
                    ...
                    {/* Web Developer badge */}
                    <div className=" text-center bg-purple-500 mb-10 rounded-md">
